                    ...
                    <PieChart
                        ...
                        <TipButton title="Time intervals between bet placements">
                            <p style={{textAlign: "left"}}>
                                ...
                                - If the widget displays these time intervals with more than 3 bets, it can be inferred with a high degree of probability that a bot or other external means were utilized. <br/>
                            </p>
                        </TipButton>
                </div>
                :

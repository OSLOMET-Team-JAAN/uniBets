                ...
                <div className={styles["accordion-wrapper"]}>
                    ...
                    <AccordionBody className={styles["accordion-body"]}>
                        <p className="break-words">
                            ...
                            of the outcome of a match by one or more players.It is considered a form of cheating,
                ...
                <div className={styles["accordion-wrapper"]}>
                    ...
                    <AccordionBody className={styles["accordion-body"]}>
                        <p className="break-words">
                            ...
                            of corruption in sports, which is "any illegal, immoral, or unethical activity that attempts
